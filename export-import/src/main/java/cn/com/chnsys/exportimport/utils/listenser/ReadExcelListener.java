package cn.com.chnsys.exportimport.utils.listenser;
 ...
 * @author yuxt
 **/
public class ReadExcelListener extends AnalysisEventListener<TestTable> {
    ...
    public ReadExcelListener(ITestTableService service) {
     ...
     */
    @Override
    public void invoke(TestTable data, AnalysisContext context) {
    ...
    private void saveData() {
        ...
        for(TestTable testTable : list){
            service.insertTestTable(testTable);
        }
        LOGGER.info("存储数据库成功！");
    }
}